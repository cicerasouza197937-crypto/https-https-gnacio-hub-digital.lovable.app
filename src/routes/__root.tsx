...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Ferramentas, material hidráulico e elétrico, EPI's, pesca e camping no Jardim Europa, Uberlândia. Aberto todos os dias, com delivery." },
